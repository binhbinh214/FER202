...
const Gameplay = ({ gameplayFeatures }) => {
  return (
    <Container fluid className="gameplay-page text-center">
      ...
      <Card
        className="mega-evolution-card mt-5"
          ...
          <Row className="justify-content-center">
            <Col md={8}>
              ...
              <div className="mega-evolution-title-box">
                <h2 className="mega-evolution-title">
              ...
              <p className="mega-evolution-description">
                In Lumiose City, you'll sometimes see Pokémon undergo Mega
                Evolution—a kind of Evolution that transcends standard
                Evolution. Effectively using Mega Evolution will likely be the
                key to victory in Pokémon battles.
              </p>
              ...
              <div className="mega-evolution-details">
                <p>
                  ...
                  Only certain Pokémon can Mega Evolve. Doing so imparts power
                  greater than regular Evolution by temporarily unleashing the
                  energy hidden within the Pokémon. Pokémon change their
                  appearance when they Mega Evolve, and certain Pokémon may even
                  change types.
                </p>
                <p>
                  When Trainers have a strong bond with their Pokémon, a Key
                  Stone worn by the Trainer resonates with a Mega Stone held by
                  their Pokémon, allowing Mega Evolution to take place.
                  Eventually, you'll wear a Mega Ring with a Key Stone embedded
                  in it. Other Trainers may wear their Key Stones in different
                  ways.
                </p>
              </div>
              <Image
