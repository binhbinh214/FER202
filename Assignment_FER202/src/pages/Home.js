...
const Home = () => {
  ...
  const [startIndex, setStartIndex] = useState(0); // Track the starting position
  ...
  // Move to the previous Pokémon group
  const handlePrev = () => {
  ...
  // Move to the next Pokémon group
  const handleNext = () => {
    setStartIndex((prevIndex) =>
  ...
  // Get 3 Pokémon to display
  const displayedPokemon = pokemonList.slice(
    startIndex,
    startIndex + itemsPerPage
  );

  // Check if the "previous" and "next" buttons should be displayed
  ...
  return (
    <div className="homepage">
      <Container fluid className="pokemon-promo text-center">
        ...
        {/* Main image of Pokémon Legends: Z-A */}
        <Image
          src="/images/main.jpg"
        ...
        <Modal show={showModal} onHide={handleClose} centered size="xl">
          <Modal.Header closeButton>
            <Modal.Title>Pokémon Legends: Z-A Trailer</Modal.Title>
          </Modal.Header>
          <Modal.Body>
        ...
        {/* Card wrapping the new Pokémon introduction section */}
